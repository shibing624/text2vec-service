...
<p align="center">
  ...
  <a href="https://pypi.org/search/?q=bert-serving">
      <img src="https://img.shields.io/pypi/v/nlp-server.svg?colorB=brightgreen"
           alt="Pypi package">
    </a>
  ...
  <a href="https://pypi.org/search/?q=bert-serving">
      <img alt="PyPI - Downloads" src="https://img.shields.io/pypi/dm/nlp-server">
  </a>
...
```bash
pip install nlp-server  # server
pip install nlp-client  # client, independent of `nlp-server`
```
...
**A:** [BERT code of this repo](server/service/server/bert/) is forked from the [original BERT repo](https://github.com/google-research/bert) with necessary modification, [especially in extract_features.py](server/service/server/bert/extract_features.py).
